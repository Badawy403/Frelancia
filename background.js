...
chrome.runtime.onInstalled.addListener(() => {
  ...
  chrome.storage.local.get(['settings', 'seenJobs', 'stats', 'trackedProjects', 'prompts', 'recentJobs', 'proposalTemplate'], (data) => {
    ...
    if (!data.proposalTemplate) {
      changes.proposalTemplate = `تحية طيبة، لقد قرأت تفاصيل مشروعك بعناية ووجدت في نفسي الشغف والخبرة لتحويل فكرتك إلى واقع متميز يفوق التوقعات. اهتمامي بالتفاصيل هو ما يميزني، وأنا ملتزم بتقديم عمل احترافي يفتخر به كلانا.
