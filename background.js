...
chrome.runtime.onInstalled.addListener(() => {
  ...
  chrome.storage.local.get(['settings', 'seenJobs', 'stats', 'trackedProjects', 'prompts', 'recentJobs', 'proposalTemplate'], (data) => {
    ...
    if (!data.proposalTemplate) {
      changes.proposalTemplate = `اطلعت على مشروعك وفهمت متطلباته جيدا، وأرى أنني قادر على تقديم العمل بطريقة منظمة وجذابة. احرص على الدقة لضمان ان تكون النتيجة مرضية تماما لك.
